...
sudo gsutil -m cp gs://startup_scripts_us/scripts/go-wolk/swarm-bashrc-centos7-bootnode-12 /root/.bashrc;
gsutil -m cp gs://startup_scripts_us/scripts/go-wolk/swarm-bashrc-centos7-bootnode-12 /home/anand/.bashrc;
...
"
sudo docker pull wolkinc/go-wolk-phobos-bootnode-12a;
sudo docker run --dns=8.8.8.8 --dns=8.8.4.4 --name=go-wolk-phobos-bootnode-12a --rm -dit -p 8545:8545 -p 30303:30303  -p 30303:30303/udp -p 30304:30304/udp wolkinc/go-wolk-phobos-bootnode-12a
...
sudo su - << EOF
docker pull wolkinc/go-wolk-phobos-bootnode-12a
EOF
else
echo "
