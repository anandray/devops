...
"
sudo docker pull wolkinc/go-wolk-phobos-bootnode-12;
sudo docker run --dns=8.8.8.8 --dns=8.8.4.4 --name=go-wolk-phobos-bootnode-12 --rm -dit -p 8545:8545 -p 30303:30303  -p 30303:30303/udp -p 30304:30304/udp wolkinc/go-wolk-phobos-bootnode-12
...
sudo su - << EOF
docker pull wolkinc/go-wolk-phobos-bootnode-12
EOF
else
echo "
