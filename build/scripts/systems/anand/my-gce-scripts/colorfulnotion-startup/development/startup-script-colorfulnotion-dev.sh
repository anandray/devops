...
if [ ! -d /home/goracing/go_projects/src/goracing.colorfulnotion.com ]; then
	...
	git clone --recurse-submodules -b development git@github.com:colorfulnotion/goracing.colorfulnotion.com.git
...
sudo gsutil -m cp gs://startup-scripts-colorfulnotion/scripts/goracing-dev-*start.sh /root/scripts
sudo gsutil -m cp gs://startup-scripts-colorfulnotion/scripts/crontab-dev /var/spool/cron/root
...
# start goracing development
#sh /root/scripts/goracing-dev-start.sh
