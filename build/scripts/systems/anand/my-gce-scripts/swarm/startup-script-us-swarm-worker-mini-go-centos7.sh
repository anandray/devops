...
# download geth and swarm binaries
        sudo su - << EOF
wget -O /usr/bin/geth https://github.com/wolktoken/swarm.wolk.com/raw/master/src/github.com/ethereum/go-ethereum/build/bin/geth
wget -O /usr/bin/swarm https://github.com/wolktoken/swarm.wolk.com/raw/master/src/github.com/ethereum/go-ethereum/build/bin/swarm
wget -O /usr/bin/bootnode https://github.com/wolktoken/swarm.wolk.com/raw/master/src/github.com/ethereum/go-ethereum/build/bin/bootnode
