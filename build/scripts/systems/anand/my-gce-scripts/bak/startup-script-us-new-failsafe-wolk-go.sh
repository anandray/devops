...
#Copy CRONJOBS:
sudo su - << EOF
gsutil -m cp gs://startup_scripts_us/scripts/cron_root-us-wolk-go /var/spool/cron/root;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/startup-script-us-new-failsafe-wolk-go.sh /root/scripts/;
