...
sudo gsutil cp gs://startup_scripts_us/scripts/httpd_conf-us-chatbot.sh /root/scripts/;
...
sudo sh /root/scripts/httpd_conf-us-chatbot.sh
...
sudo gsutil cp gs://startup_scripts_us/scripts/htaccess /var/www/vhosts/mdotm.com/httpdocs/.htaccess
EOF
