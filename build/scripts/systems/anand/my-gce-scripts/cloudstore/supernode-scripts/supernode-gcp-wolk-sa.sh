# core inputs
region=sa
gcregion="southamerica-east1"
primaryzone="southamerica-east1-b"
...
project="wolk-$region"
provider="gc"
fixedinstance="wolk-$node-$provider-$region-datastore-$node"
