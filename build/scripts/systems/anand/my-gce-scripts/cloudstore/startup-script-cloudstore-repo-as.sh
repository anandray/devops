...
wget -O /root/scripts/wolk-as-f0d81824dfc3.json http://www6001.wolk.com/.start/wolk-as-f0d81824dfc3.json
sudo mkdir -p /root/.google
sudo cp -rf /root/scripts/wolk-as-f0d81824dfc3.json /root/.google
gcloud auth activate-service-account --key-file /root/scripts/wolk-as-f0d81824dfc3.json
...
sudo gsutil cp gs://startup_scripts_us/scripts/plasma/cloudstore-repo-bashrc-as /root/.bashrc
...
export GOOGLE_APPLICATION_CREDENTIALS="/root/.google/wolk-as-f0d81824dfc3.json"
