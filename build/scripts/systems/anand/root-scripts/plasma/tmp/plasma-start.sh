...
scp -C -p /root/scripts/plasma-start.sh 47.91.105.205:/root/scripts/ 2>&1 &
scp -C -p /root/scripts/plasma-start.sh 149.129.217.64:/root/scripts/ 2>&1 &
...
scp -C -p /root/scripts/plasma-start.sh 13.126.94.230:/root/scripts/ 2>&1 &
scp -C -p /root/scripts/plasma-start.sh 52.47.189.22:/root/scripts/ 2>&1 &
scp -C -p /root/scripts/plasma-start.sh 52.59.224.202:/root/scripts/ 2>&1 &
...
scp -C -p /root/scripts/plasma-start.sh 18.231.4.13:/root/scripts/ 2>&1 &
...
scp -C -p /root/scripts/plasma-start.sh 23.97.179.160:/root/scripts/ 2>&1 &
scp -C -p /root/scripts/plasma-start.sh 23.101.232.215:/root/scripts/ 2>&1 &
scp -C -p /root/scripts/plasma-start.sh 23.97.169.168:/root/scripts/ 2>&1 &
scp -C -p /root/scripts/plasma-start.sh 40.86.223.150:/root/scripts/ 2>&1 &
scp -C -p /root/scripts/plasma-start.sh 52.221.179.3:/root/scripts/ 2>&1 &
