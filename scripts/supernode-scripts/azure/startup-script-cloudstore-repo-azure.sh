...
sudo azcopy --source https://wolkaz.file.core.windows.net/wolk-startup-scripts/scripts/nagios/plugins/ --destination /usr/lib64/nagios/plugins/ --source-key CG4pGq6GMTOoIvNiYWa5F0I4s2byQVAFxkExCVLRqlN09qP2C/MF7ATm3RTkMr60Og/thbSlbGnrf8+v3Ot7pQ== --quiet
