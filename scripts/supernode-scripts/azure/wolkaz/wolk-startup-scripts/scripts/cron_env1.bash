...
HISTSIZE=20000
SSH_CLIENT=50.225.47.189 55455 22
SSH_TTY=/dev/pts/3
HISTFILESIZE=40000
USER=root
...
PATH=/usr/local/share/google/google-cloud-sdk/bin:/var/www/vhosts/mdotm.com/scripts/utils:/usr/local/nagios/libexec:/usr/local/share/google/google-cloud-sdk/bin:/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/hadoop/bin:/usr/local/go/bin:/var/www/vhosts/crosschannel.com/go/bin/:/root/bin
PWD=/disk1/infogroup/new
...
LOGNAME=root
CVS_RSH=ssh
SSH_CONNECTION=50.225.47.189 55455 10.128.1.15 22
GOPATH=/var/www/vhosts/crosschannel.com/go:/var/www/vhosts/crosschannel.com/bidder:/var/www/vhosts/colorfulnotion.com:/var/www/vhosts/colorfulnotion.com/roam
LESSOPEN=||/usr/bin/lesspipe.sh %s
HISTTIMEFORMAT=[%F %T] 
G_BROKEN_FILENAMES=1
_=/bin/env
OLDPWD=/disk1/infogroup
