...
#sudo sed -i 's/upload_max_filesize = 2M/upload_max_filesize = 2048M/g' /etc/php.ini;
#sudo sed -i 's/max_file_uploads = 20/max_file_uploads = 1024/g' /etc/php.ini;
#sudo sed -i 's/post_max_size = 8M/post_max_size = 2048M/g' /etc/php.ini;
...
gsutil cp gs://startup_scripts_us/scripts/php.ini /etc/php.ini;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/startup-script-us-new-failsafe.sh /root/scripts/;
