...
sudo gsutil -m cp gs://startup_scripts_us/scripts/geth/geth-install.sh /root/scripts/;
...
#Copy CRONJOBS:
sudo su - << EOF
gsutil -m cp gs://startup_scripts_us/scripts/cron-swarm.sh /var/spool/cron/root;
