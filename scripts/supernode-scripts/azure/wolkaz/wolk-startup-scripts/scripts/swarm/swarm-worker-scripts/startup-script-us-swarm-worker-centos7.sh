...
sudo gsutil -m cp gs://startup_scripts_us/scripts/swarm/swarm-worker-scripts/swarm-worker-bashrc-centos7 /root/.bashrc;
sudo gsutil -m cp gs://startup_scripts_us/scripts/swarm/swarm-worker-scripts/* /root/scripts/;
