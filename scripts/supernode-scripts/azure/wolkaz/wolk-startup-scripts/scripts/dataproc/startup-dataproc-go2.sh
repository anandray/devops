...
#y no '' | sudo pecl install mongo;
#y sudo pecl install mongodb;
#y sudo su - << EOF
#y sed -i '/mongo/d' /etc/php5/cli/php.ini;
#y echo 'extension=mongo.so' >> /etc/php5/cli/php.ini;
#y echo ';extension=mongodb.so' >> /etc/php5/cli/php.ini;
#y EOF
...
# installing hbase
#y gsutil cp gs://startup_scripts_us/scripts/hbase/hbase-install-ha6-go.sh /home/anand;
#y sh /home/anand/hbase-install-ha6-go.sh;
