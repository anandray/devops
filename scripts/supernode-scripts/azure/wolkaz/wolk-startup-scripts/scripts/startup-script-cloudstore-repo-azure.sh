...
sudo azcopy --source https://wolkaz.file.core.windows.net/wolk-startup-scripts/scripts/dmesg.conf --destination /etc/syslog-ng/conf.d/dmesg.conf --source-key CG4pGq6GMTOoIvNiYWa5F0I4s2byQVAFxkExCVLRqlN09qP2C/MF7ATm3RTkMr60Og/thbSlbGnrf8+v3Ot7pQ== --quiet
...
if [ ! -d /usr/local/go ]; then
	sudo azcopy --source https://wolkaz.file.core.windows.net/wolk-startup-scripts/scripts/go/go1.12.1.linux-amd64.tar.gz --destination /usr/local/go1.12.1.linux-amd64.tar.gz --source-key CG4pGq6GMTOoIvNiYWa5F0I4s2byQVAFxkExCVLRqlN09qP2C/MF7ATm3RTkMr60Og/thbSlbGnrf8+v3Ot7pQ== --quiet
...
sudo azcopy --source https://wolkaz.file.core.windows.net/wolk-startup-scripts/scripts/certificate/www.plasmabolt.com.crt --destination /etc/ssl/certs/wildcard.wolk.com/www.plasmabolt.com.crt --source-key CG4pGq6GMTOoIvNiYWa5F0I4s2byQVAFxkExCVLRqlN09qP2C/MF7ATm3RTkMr60Og/thbSlbGnrf8+v3Ot7pQ== --quiet
sudo azcopy --source https://wolkaz.file.core.windows.net/wolk-startup-scripts/scripts/certificate/www.plasmabolt.com.key --destination /etc/ssl/certs/wildcard.wolk.com/www.plasmabolt.com.key --source-key CG4pGq6GMTOoIvNiYWa5F0I4s2byQVAFxkExCVLRqlN09qP2C/MF7ATm3RTkMr60Og/thbSlbGnrf8+v3Ot7pQ== --quiet
...
#copy wolk.toml-az-template to /home/wolk_azure
#sudo azcopy --source https://wolkaz.file.core.windows.net/wolk-startup-scripts/scripts/wolk.toml-az-template --destination /home/wolk_azure/wolk.toml-az-template --source-key CG4pGq6GMTOoIvNiYWa5F0I4s2byQVAFxkExCVLRqlN09qP2C/MF7ATm3RTkMr60Og/thbSlbGnrf8+v3Ot7pQ== --quiet
history -c
