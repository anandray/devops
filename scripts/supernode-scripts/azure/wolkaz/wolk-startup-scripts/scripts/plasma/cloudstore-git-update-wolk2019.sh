...
/root/.local/bin/aws s3 cp s3://wolk-startup-scripts/scripts/nagios/plugins/check_wolk_healthcheck.sh /usr/lib64/nagios/plugins/
/root/.local/bin/aws s3 cp s3://wolk-startup-scripts/scripts/nagios/plugins/check_wolk_healthcheck_ssl.sh /usr/lib64/nagios/plugins/
...
/root/.local/bin/aws s3 cp s3://wolk-startup-scripts/scripts/cloudstore/credentials-wolk2019 /root/.aws/credentials
/root/.local/bin/aws s3 cp s3://wolk-startup-scripts/scripts/cloudstore/credentials-wolk2019 /root/go/src/github.com/wolkdb/cloudstore/wolk/cloud/credentials/credentials
chmod +x /usr/lib64/nagios/plugins/check_wolk_healthcheck*
chmod +x /usr/local/bin/sqlite3
/root/.local/bin/aws s3 cp s3://wolk-startup-scripts/scripts/nagios/nrpe.cfg /etc/nagios/nrpe.cfg
