...
gsutil cp gs://startup_scripts_us/scripts/hbase/hbasechk-as.sh /root/scripts/;
...
sh /root/scripts/hbasechk-as.sh;
...
echo '*/1 * * * * ssh `hostname` /bin/sh /root/scripts/hbasechk-eu.sh > /var/log/hbase-eu.log 2>&1' >> /var/spool/cron/crontabs/root;
echo '*/1 * * * * ssh `hostname` /bin/sh /root/scripts/hbasechk-as.sh > /var/log/hbase-as.log 2>&1' >> /var/spool/cron/crontabs/root;
EOF
