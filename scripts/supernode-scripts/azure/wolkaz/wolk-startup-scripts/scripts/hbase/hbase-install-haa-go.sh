...
mkdir /root/scripts/;
gsutil cp gs://startup_scripts_us/scripts/hbase/hbasechk-haa-go.sh /root/scripts/;
...
/sbin/sysctl -p;
sh /root/scripts/hbasechk-haa-go.sh;
...
echo "* * * * * /bin/sh /root/scripts/hbasechk-haa-go.sh > /var/log/hbasechk-haa-go.log 2>&1" >> /var/spool/cron/crontabs/root;
