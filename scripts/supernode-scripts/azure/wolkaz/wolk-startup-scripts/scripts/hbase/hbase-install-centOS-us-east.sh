...
gsutil cp gs://startup_scripts_us/scripts/hbase/hbasechk-us-east.sh /root/scripts;
...
/sbin/sysctl -p;
sh /root/scripts/hbasechk-us-east.sh;
sed -i '/hbasechk/d' /var/spool/cron/root;
echo '*/1 * * * * /bin/sh /root/scripts/hbasechk-us-east.sh > /var/log/hbase.log 2>&1' >> /var/spool/cron/root;
#echo '*/1 * * * * ssh `hostname` /bin/sh /root/scripts/hbasechk-us-east.sh > /var/log/hbase.log 2>&1' >> /var/spool/cron/root;
