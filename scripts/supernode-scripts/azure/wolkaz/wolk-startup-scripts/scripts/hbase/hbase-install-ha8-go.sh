...
mkdir /root/scripts/;
gsutil cp gs://startup_scripts_us/scripts/hbase/hbasechk-ha8-go.sh /root/scripts/;
...
/sbin/sysctl -p;
sh /root/scripts/hbasechk-ha8-go.sh;
...
echo "* * * * * /bin/sh /root/scripts/hbasechk-ha8-go.sh > /var/log/hbasechk-ha8-go.log 2>&1" >> /var/spool/cron/crontabs/root;
