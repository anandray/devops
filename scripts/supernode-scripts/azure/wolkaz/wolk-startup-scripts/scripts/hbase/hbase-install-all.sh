...
cp -rf /usr/local/hbase-1.1.2 /usr/local/hbase-eu;
cp -rf /usr/local/hbase-1.1.2 /usr/local/hbase-as;
...
gsutil cp gs://startup_scripts_us/scripts/hbase/hbase-site-eu.xml /usr/local/hbase-eu/conf/hbase-site.xml;
gsutil cp gs://startup_scripts_us/scripts/hbase/hbase-site-as.xml /usr/local/hbase-as/conf/hbase-site.xml;
#echo 'export JAVA_HOME=/usr/lib/jvm/jre-1.8.0-openjdk.x86_64/' >> /root/.bashrc;
#export JAVA_HOME=/usr/lib/jvm/jre-1.8.0-openjdk.x86_64/;
mkdir /root/scripts/;
gsutil cp gs://startup_scripts_us/scripts/hbase/hbasechk-all.sh /root/scripts/;
...
#gsutil cp gs://startup_scripts_us/scripts/hbase/hbasechk-eu-1.sh /root/scripts/;
#gsutil cp gs://startup_scripts_us/scripts/hbase/hbasechk-as-1.sh /root/scripts/;
...
/sbin/sysctl -p;
sh /root/scripts/hbasechk-all.sh;
#sh /root/scripts/hbasechk.sh;
#sh /root/scripts/hbase-profile-chk.sh;
#sh /root/scripts/hbasechk-eu-1.sh;
#sh /root/scripts/hbasechk-as-1.sh;
echo '*/1 * * * * /bin/sh /root/scripts/hbasechk-all.sh > /var/log/hbasechk-all.log 2>&1' >> /var/spool/cron/crontabs/root;
#echo '*/1 * * * * ssh `hostname` /bin/sh /root/scripts/hbasechk.sh > /var/log/hbase.log 2>&1' >> /var/spool/cron/crontabs/root;
#echo '*/1 * * * * ssh `hostname` /bin/sh /root/scripts/hbase-profile-chk.sh > /var/log/hbase-profile.log 2>&1' >> /var/spool/cron/crontabs/root;
#echo '*/1 * * * * ssh `hostname` /bin/sh /root/scripts/hbasechk-eu-1.sh > /var/log/hbase-eu.log 2>&1' >> /var/spool/cron/crontabs/root;
#echo '*/1 * * * * ssh `hostname` /bin/sh /root/scripts/hbasechk-as-1.sh > /var/log/hbase-as.log 2>&1' >> /var/spool/cron/crontabs/root;
EOF
