...
# copy rpms from gs://startup_scripts_us/scripts/rpms/
/usr/bin/gsutil -m cp -r gs://startup_scripts_us/scripts/rpms /home/anand/;

#PST date time
sudo ln -sf /usr/share/zoneinfo/America/Los_Angeles /etc/localtime;
#sudo yum -y install ntpdate rdate;
#sudo rpm -Uvh /home/anand/rpms/*ntpdate*.rpm;
#sudo rpm -Uvh /home/anand/rpms/*rdate*.rpm;
...
#sudo rpm -Uvh /home/anand/rpms/epel-release*.rpm; # already installed from start
sudo rpm -Uvh /home/anand/rpms/ius-release*.rpm;
sudo rm -rf /home/anand/rpms/ius-release*.rpm;
sudo su - << EOF
...
sudo rpm -Uvh /home/anand/rpms/*.rpm;
...
# php extensions
sudo gsutil -m cp gs://startup_scripts_us/scripts/php_modules/pdf.so /usr/lib64/php/modules/ 2>&1 &
sudo gsutil -m cp gs://startup_scripts_us/scripts/php_modules/lua.so /usr/lib64/php/modules/ 2>&1 &
sudo gsutil -m cp gs://startup_scripts_us/scripts/php_modules/igbinary.so /usr/lib64/php/modules/ 2>&1 &
sudo gsutil -m cp gs://startup_scripts_us/scripts/php_modules/maxminddb.so /usr/lib64/php/modules/ 2>&1 &
sudo gsutil -m cp gs://startup_scripts_us/scripts/php_modules/geoip.so /usr/lib64/php/modules/ 2>&1 &
sudo gsutil -m cp gs://startup_scripts_us/scripts/php_modules/apc.so /usr/lib64/php/modules/ 2>&1 &
sudo gsutil -m cp gs://startup_scripts_us/scripts/php_modules/ssh2.so /usr/lib64/php/modules/ 2>&1 &
sudo gsutil -m cp gs://startup_scripts_us/scripts/php_modules/apc.ini /etc/php.d/ 2>&1 &

sudo gsutil -m cp gs://startup_scripts_us/scripts/php_modules/rpms/* /home/anand/ 2>&1 &
...
#rpm -Uvh /home/anand/rpms/maxminddb-rpms/*.rpm
...
# files to copy from gs://startup_scripts_us/scripts/php_modules/maxminddb
#/usr/lib64/libmaxminddb.a
#/usr/lib64/libmaxminddb.la
#/usr/lib64/libmaxminddb.so
#/usr/lib64/libmaxminddb.so.0
#/usr/lib64/libmaxminddb.so.0.0.7
#/usr/lib64/php/modules/maxminddb.so # already copied earlier
...
#/usr/local/share/man/man3/libmaxminddb.3

sudo su - << EOF
gsutil -m cp -r gs://startup_scripts_us/scripts/php_modules/maxminddb/libmaxminddb* /usr/lib64/
gsutil -m cp -r gs://startup_scripts_us/scripts/php_modules/maxminddb/libmaxminddb* /usr/local/include/
gsutil -m cp -r gs://startup_scripts_us/scripts/php_modules/maxminddb/libmaxminddb.pc /usr/local/lib/pkgconfig/
ldconfig /usr/local/lib/
EOF
#######
...
rpm -Uvh /home/anand/rpms/nagios/*.rpm;
gsutil cp gs://startup_scripts_us/scripts/nagios/nrpe.cfg /etc/nagios/;
gsutil -m cp gs://startup_scripts_us/scripts/nagios/plugins/* /usr/lib64/nagios/plugins/;
...
sudo gsutil cp gs://startup_scripts_us/scripts/git_clone_cc.sh /root/scripts;
...
sudo gsutil cp gs://startup_scripts_us/scripts/startup-script-us-new-rpms-failsafe.sh /root/scripts/;
gsutil cp gs://startup_scripts_us/scripts/python_version_change.sh /root/scripts/;
gsutil cp gs://startup_scripts_us/scripts/python_version_change_cron.sh /root/scripts/;
...
sudo ssh `hostname` /usr/bin/php /var/www/vhosts/mdotm.com/cron/www/loadAll.php > /var/log/loadall.log 2>&1;
...
################
#Denyhosts
sudo gsutil cp gs://startup_scripts_us/scripts/denyhosts/allowed-hosts /var/lib/denyhosts/;
sudo gsutil cp gs://startup_scripts_us/scripts/denyhosts/denyhosts.conf /etc;
sudo su - << EOF
