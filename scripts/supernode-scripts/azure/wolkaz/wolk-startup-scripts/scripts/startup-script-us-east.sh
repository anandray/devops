...
sudo gsutil -m cp gs://startup_scripts_us/scripts/startup-script-us-east-failsafe.sh /root/scripts/;
gsutil -m cp gs://startup_scripts_us/scripts/python_version_change.sh /root/scripts/;
gsutil -m cp gs://startup_scripts_us/scripts/python_version_change_cron.sh /root/scripts/;
...
# installing GO
sudo su - << EOF
gsutil -m cp gs://startup_scripts_us/scripts/go/go-install.sh /root/scripts;
