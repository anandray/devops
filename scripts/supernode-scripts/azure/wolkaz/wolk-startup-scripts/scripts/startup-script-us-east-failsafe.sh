...
#sudo gsutil -m cp -r gs://startup_scripts_us/scripts/rpm_packages/ /root/scripts/;
...
#Copy CRONJOBS:
sudo su - << EOF
gsutil -m cp gs://startup_scripts_us/scripts/cron_root-us-east /var/spool/cron/root;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/hbase/hbasechk-us-east.sh /root/scripts;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/nagios/startup-script-us-east-failsafe.sh /root/scripts/;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/hbase/hbase-install-centOS-us-east.sh /home/anand;
