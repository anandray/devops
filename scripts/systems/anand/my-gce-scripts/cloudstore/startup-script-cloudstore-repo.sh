...
sudo gsutil cp gs://startup_scripts_us/scripts/cloudstore/cloudstore-sudoers /etc/sudoers;
...
sudo gsutil cp gs://startup_scripts_us/scripts/plasma/cloudstore-bashrc /.bashrc
sudo gsutil cp gs://startup_scripts_us/scripts/plasma/cloudstore-bashrc_aliases /root/.bashrc_aliases
