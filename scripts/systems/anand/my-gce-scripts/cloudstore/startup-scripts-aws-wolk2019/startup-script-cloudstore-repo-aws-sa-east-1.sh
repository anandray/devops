...
echo "[default]
output = json
region = sa-east-1" > /root/.aws/config

echo "[default]
aws_access_key_id = AKIAJU4Z5ORV6URZL7NA
aws_secret_access_key = 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" >  /root/.aws/credentials
