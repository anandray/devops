...
#/usr/bin/geoipupdate -v > /var/log/geoipupdate.log
...
sudo gsutil cp gs://startup_scripts_us/scripts/httpd_conf-us-mopub-go.sh /root/scripts/;
...
sudo gsutil cp gs://startup_scripts_us/scripts/startup-script-us-east-failsafe-mopub-go.sh /root/scripts/;
gsutil cp gs://startup_scripts_us/scripts/python_version_change.sh /root/scripts/;
gsutil cp gs://startup_scripts_us/scripts/python_version_change_cron.sh /root/scripts/;
sudo chmod -R +x /root/scripts
sudo sh /root/scripts/httpd_conf-us-mopub-go.sh
...
#Copy CRONJOBS:
sudo su - << EOF
gsutil cp gs://startup_scripts_us/scripts/cron_root-us-east-mopub-go /var/spool/cron/root;
...
cd /var/www/vhosts/crosschannel.com/bidder/bin && php goservice.php mopub 2> /var/log/git-mopub.err  > /var/log/git-mopub.log
EOF
