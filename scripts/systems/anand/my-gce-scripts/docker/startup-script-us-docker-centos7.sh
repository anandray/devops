...
if [ ! -d /var/www/vhosts/netstats.wolk.com ]; then
	...
	mkdir -p /var/www/vhosts;
        cd /var/www/vhosts/;
	git clone -v git@github.com:wolktoken/netstats.wolk.com.git
	cd netstats.wolk.com
	git remote -v add upstream git@github.com:wolktoken/netstats.wolk.com.git
...
#docker run --name=wolkmain -p 8500:8500 -p 5001:5000 wolkmain
EOF

# wolknode
#docker build -t wolknode . &&
#docker run --name=wolknode -v /var/lib/docker/overlay:/mnt --rm -it -p 8501:8500 -p 5002:5000 wolknode
