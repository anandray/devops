...
sudo gsutil cp gs://startup_scripts_us/scripts/swarm/swarm-sudoers-demo /etc/sudoers;
...
if [ ! -d /var/www/vhosts/demo-swarm.wolk.com ]; then
        echo "/var/www/vhosts/demo-swarm.wolk.com does NOT exist, proceeding with git clone..."
        sudo su - << EOF
	mkdir -p /var/www/vhosts;
        cd /var/www/vhosts/;
	git clone -v git@github.com:wolktoken/demo-swarm.wolk.com.git
	cd demo-swarm.wolk.com
	git remote -v add upstream git@github.com:wolktoken/demo-swarm.wolk.com.git
...
sudo sh /home/anand/go-install-swarm.sh;

#############

# installing geth/swarm/evm/etc... <-- NO LONGER NEEDED AS THE BINARIES ARE IN GIT
#if [ ! -d /var/www/vhosts/demo-swarm.wolk.com/src/github.com/ethereum/go-ethereum/build/bin ]; then
#echo "Compiling GETH..."
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/swarm/demo-swarm-bashrc /root/.bashrc;
gsutil -m cp gs://startup_scripts_us/scripts/swarm/demo-swarm-bashrc /home/anand/.bashrc;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/swarm/geth-install-demo.sh /root/scripts/;
...
#sudo gsutil -m cp gs://startup_scripts_us/scripts/swarm/swarm-sudoers-demo /etc/sudoers;
