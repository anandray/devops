...
echo "php54 is installed... Commenting out in crontab"
...
#Copy CRONJOBS:
sudo su - << EOF
gsutil cp gs://startup_scripts_us/scripts/cron_root-as /var/spool/cron/root;
...
sudo gsutil cp gs://startup_scripts_us/scripts/httpd_conf-as.sh /root/scripts/;
...
sudo gsutil cp gs://startup_scripts_us/scripts/hbase/hbasechk-as.sh /root/scripts;
...
sudo gsutil cp gs://startup_scripts_us/scripts/hbase/hbase-install-centOS-as.sh /home/anand;
...
cp -rfv /root/scripts/python_version_change.sh /etc/cron.hourly/
cp -rfv /root/scripts/python_version_change_cron.sh /etc/cron.d/
chmod 0755 /etc/cron.d/python_version_change.sh
chmod 0755 /etc/cron.d/python_version_change_cron.sh
EOF
