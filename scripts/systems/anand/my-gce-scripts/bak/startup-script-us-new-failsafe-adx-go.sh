...
#Copy CRONJOBS:
sudo su - << EOF
gsutil -m cp gs://startup_scripts_us/scripts/cron_root-us-adx-go /var/spool/cron/root;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/startup-script-us-new-failsafe-adx-go.sh /root/scripts/;
