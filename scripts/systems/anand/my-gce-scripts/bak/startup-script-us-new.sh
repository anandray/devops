...
sudo su - << EOF
cd /var/www/vhosts
sudo git clone -v git@github.com:sourabhniyogi/mdotm.com.git /var/www/vhosts/mdotm.com;
cd /var/www/vhosts/mdotm.com/;
sudo git remote -v add upstream git@github.com:sourabhniyogi/mdotm.com.git;
...
if [ ! -d /var/www/vhosts/crosschannel.com ]; then
        ...
        sudo su - << EOF
        cd /var/www/vhosts
        sudo git clone -v git@github.com:sourabhniyogi/crosschannel.com.git /var/www/vhosts/crosschannel.com;
        cd /var/www/vhosts/crosschannel.com/;
        git remote -v add upstream git@github.com:sourabhniyogi/crosschannel.com.git;
