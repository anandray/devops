...
sudo gsutil cp gs://startup_scripts_us/scripts/go/go-crosschannel-install.sh /root/scripts;
...
sudo gsutil cp gs://startup_scripts_us/scripts/startup-script-us-east-failsafe-go.sh /root/scripts/;
...
#Copy CRONJOBS:
sudo su - << EOF
gsutil cp gs://startup_scripts_us/scripts/cron_root-us-east-go /var/spool/cron/root;
service crond restart;
EOF

# installing GO
sudo su - << EOF
gsutil cp gs://startup_scripts_us/scripts/go/go-crosschannel-install.sh /root/scripts;
