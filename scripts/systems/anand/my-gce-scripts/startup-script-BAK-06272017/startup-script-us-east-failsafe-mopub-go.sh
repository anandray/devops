...
/bin/sed -i 's/\*\/1 \* \* \* \* \/usr\/bin\/flock \-w 0 \/var\/run\/startup-script-us-east-failsafe-mopub-go.lock \/bin\/sh \/root\/scripts\/startup-script-us-east-failsafe-mopub-go.sh/\#\*\/1 \* \* \* \* \/usr\/bin\/flock \-w 0 \/var\/run\/startup-script-us-east-failsafe-mopub-go.lock \/bin\/sh \/root\/scripts\/startup-script-us-east-failsafe-mopub-go.sh/g' /var/spool/cron/root
