...
#Copy CRONJOBS:
sudo su - << EOF
gsutil cp gs://startup_scripts_us/scripts/cron_root-us-ccdex-mayumi-go /var/spool/cron/root;
...
sudo gsutil cp gs://startup_scripts_us/scripts/startup-script-us-new-failsafe-ccdex-mayumi-go.sh /root/scripts/;
...
sed -i 's/\*\/1 \* \* \* \* \/usr\/bin\/flock -w 0 \/var\/run\/startup-script-us-new-failsafe-ccdex-mayumi-go.lock/#\*\/1 \* \* \* \* \/usr\/bin\/flock -w 0 \/var\/run\/startup-script-us-new-failsafe-ccdex-mayumi-go.lock/g' /var/spool/cron/root
