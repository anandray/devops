...
#Copy CRONJOBS:
sudo su - << EOF
gsutil cp gs://startup_scripts_us/scripts/cron_root-us-wolk-mayumi-go /var/spool/cron/root;
...
sudo gsutil cp gs://startup_scripts_us/scripts/startup-script-us-new-failsafe-wolk-mayumi-go.sh /root/scripts/;
...
sed -i 's/\*\/1 \* \* \* \* \/usr\/bin\/flock -w 0 \/var\/run\/startup-script-us-new-failsafe-wolk-mayumi-go.lock/#\*\/1 \* \* \* \* \/usr\/bin\/flock -w 0 \/var\/run\/startup-script-us-new-failsafe-wolk-mayumi-go.lock/g' /var/spool/cron/root
