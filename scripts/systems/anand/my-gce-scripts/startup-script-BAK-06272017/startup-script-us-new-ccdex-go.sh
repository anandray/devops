...
sudo gsutil cp gs://startup_scripts_us/scripts/startup-script-us-new-failsafe-ccdex-go.sh /root/scripts/;
...
#Copy CRONJOBS:
sudo su - << EOF
gsutil cp gs://startup_scripts_us/scripts/cron_root-us-ccdex-go /var/spool/cron/root;
