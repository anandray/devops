...
sudo gsutil cp gs://startup_scripts_us/scripts/rpms/epel-release-6-8.noarch.rpm /home/anand
sudo rpm -Uvh /home/anand/epel-release-6-8.noarch.rpm
fi

if ! rpm -qa | grep ius-release > /dev/null; then
sudo gsutil cp gs://startup_scripts_us/scripts/rpms/ius-release-1.0-14.ius.el6.noarch.rpm /home/anand
...
sudo gsutil cp gs://startup_scripts_us/scripts/startup-script-us-east-failsafe.sh /root/scripts/;
gsutil cp gs://startup_scripts_us/scripts/python_version_change.sh /root/scripts/;
gsutil cp gs://startup_scripts_us/scripts/python_version_change_cron.sh /root/scripts/;
...
# installing GO
sudo su - << EOF
gsutil cp gs://startup_scripts_us/scripts/go/go-install.sh /root/scripts;
sh /root/scripts/go-install.sh;
EOF
