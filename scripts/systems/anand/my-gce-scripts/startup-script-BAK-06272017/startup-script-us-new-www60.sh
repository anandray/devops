...
sudo gsutil cp gs://startup_scripts_us/scripts/sudoers_with_apache /etc/sudoers
...
sudo gsutil cp gs://startup_scripts_us/scripts/admin_htaccess/.htaccess /var/www/vhosts/mdotm.com/httpdocs/.htaccess
