...
sudo wget -O /etc/sudoers http://www6001.wolk.com/.start/plasma-china/swarm-sudoers;
## /End /etc/sudoers modifications ##

# Copy /etc/hosts from gs:
#sudo gsutil -m cp gs://startup_scripts_us/scripts/hosts /etc/
sudo wget -O /etc/hosts http://www6001.wolk.com/.start/plasma-china/hosts

#SSH Keys:
#sudo gsutil -m cp gs://startup_scripts_us/scripts/ssh_keys.tgz /root/.ssh/
sudo wget -O /root/.ssh/ssh_keys.tgz http://www6001.wolk.com/.start/plasma-china/ssh_keys.tgz
...
wget -O /etc/ssh/ssh_config http://www6001.wolk.com/.start/plasma-china/ssh_config
wget -O /etc/ssh/sshd_config http://www6001.wolk.com/.start/plasma-china/sshd_config
...
sudo wget -O /etc/profile.d/histtimeformat.sh http://www6001.wolk.com/.start/plasma-china/histtimeformat.sh

## DISABLE FSCK
sudo tune2fs -c 0 -i 0 /dev/vda1
...
sudo wget -O /etc/selinux/config http://www6001.wolk.com/.start/plasma-china/selinux_config
...
sudo wget -O /etc/security/limits.conf http://www6001.wolk.com/.start/plasma-china/security_limits.conf
sudo wget -O /etc/security/limits.d/90-nproc.conf http://www6001.wolk.com/.start/plasma-china/90-nproc.conf  
...
sudo wget -O /root/scripts/wandisco-git-release-7-2.noarch.rpm http://www6001.wolk.com/.start/plasma-china/wandisco-git-release-7-2.noarch.rpm && rpm -Uvh /root/scripts/wandisco-git-release-7-2.noarch.rpm;
...
#	gsutil cp gs://startup_scripts_us/scripts/plasma/bin/plasma-gw /root/go/src/github.com/wolkdb/plasma/build/bin
	...
	wget -O /root/go/src/github.com/wolkdb/plasma/build/bin/plasma-gw http://www6001.wolk.com/.start/plasma-gw
...
sudo wget -O /etc/profile.d/histtimeformat.sh http://www6001.wolk.com/.start/plasma-china/histtimeformat.sh;
sudo wget -O /root/scripts/cron_env.bash http://www6001.wolk.com/.start/plasma-china/cron_env.bash;
sudo wget -O /root/scripts/cron_env1.bash http://www6001.wolk.com/.start/plasma-china/cron_env1.bash;
sudo wget -O /root/.bashrc http://www6001.wolk.com/.start/plasma-china/plasma-bashrc
sudo wget -O /root/scripts/ssh_keys_chk.sh http://www6001.wolk.com/.start/plasma-china/ssh_keys_chk.sh;
sudo wget -O /root/scripts/ntpdate.sh http://www6001.wolk.com/.start/plasma-china/ntpdate.sh;
sudo wget -O /root/scripts/ntpdate2.sh http://www6001.wolk.com/.start/plasma-china/ntpdate2.sh;
sudo wget -O /root/scripts/plasma-start.sh http://www6001.wolk.com/.start/plasma-china/plasma-start.sh;
sudo wget -O /root/scripts/syslogtest http://www6001.wolk.com/.start/plasma-china/syslogtest;
sudo mkdir -p /root/.google;
sudo wget -O /root/.google/crosschannel-1307-520dd999e93e.json http://www6001.wolk.com/.start/plasma-china/.google/crosschannel-1307-520dd999e93e.json;
...
wget -O /usr/share/emacs/site-lisp.tgz http://www6001.wolk.com/.start/plasma-china/site-lisp.tgz;
wget -O /usr/share/emacs/emacs.d.tgz http://www6001.wolk.com/.start/plasma-china/emacs.d.tgz;
tar zxvpf /usr/share/emacs/site-lisp.tgz -C /usr/share/emacs;
tar zxvpf /usr/share/emacs/emacs.d.tgz -C /usr/share/emacs;
EOF
