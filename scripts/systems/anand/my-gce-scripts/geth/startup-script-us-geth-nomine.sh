...
# GIT CLONE go-ethereum and build ethereum
sudo su - << EOF
cd /var/www/vhosts/;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/geth/geth-bashrc-mainnet-centos7 /root/.bashrc;
gsutil -m cp gs://startup_scripts_us/scripts/geth/geth-bashrc-mainnet-centos7 /home/anand/.bashrc;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/geth/geth-start-nomine.sh /root/scripts/;
...
#Copy CRONJOBS:
sudo su - << EOF
gsutil -m cp gs://startup_scripts_us/scripts/geth/cron-geth-nomine.sh /var/spool/cron/root;
...
sudo sh /root/scripts/geth-start-nomine.sh
#sleep 10
