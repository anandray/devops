...
<VirtualHost `ifconfig eth0| grep 'inet addr:' | cut -d: -f2| awk '{print$1}'`:80>
  ServerName `hostname`
  ServerAlias rtb-adx-west.mdotm.co rtb-adx-east.mdotm.co rtb-adx-west.mdotm.com rtb-adx-east.mdotm.com ads.mdotm.com secure.mdotm.com
...
sed -i '/httpd_conf-us.sh/d' /var/spool/cron/root
