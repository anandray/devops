...
#Copy CRONJOBS:
sudo su - << EOF
gsutil -m cp gs://startup_scripts_us/scripts/cron_root-us-ccdex-mayumi-go /var/spool/cron/root;
...
sudo gsutil -m cp gs://startup_scripts_us/scripts/startup-script-us-new-failsafe-ccdex-mayumi-go.sh /root/scripts/;
