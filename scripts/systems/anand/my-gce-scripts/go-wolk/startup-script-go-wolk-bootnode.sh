...
# Compiling bootnode in go-wolk
if [ ! -f /var/www/vhosts/go-wolk/build/bin/bootnode ]; then
echo " Applying .bashrc..."
source /root/.bashrc
cd /var/www/vhosts/go-wolk
echo "Compiling bootnode..."
go build cmd/bootnode/main.go
mv main build/bin/bootnode
fi
