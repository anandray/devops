...
#sudo gsutil cp -r gs://startup_scripts_ccdata/rpm_packages/ /root/scripts/;
#sudo rpm -Uvh /root/scripts/rpm_packages/epel_ius_rpms/*.rpm;
#sudo rpm -Uvh /root/scripts/rpm_packages/stage1_rpms/*.rpm;
#sudo rpm -Uvh /root/scripts/rpm_packages/maxminddb/*.rpm;
#sudo rpm -Uvh /root/scripts/rpm_packages/ntpdate/*.rpm;
#sudo rpm -Uvh /root/scripts/rpm_packages/nagios/*.rpm;
...
sudo su - << EOF
gsutil cp gs://startup_scripts_ccdata/nagios/nrpechk.shroot/scripts/;
...
sudo gsutil cp gs://startup_scripts_ccdata/nagios/startup-script-us-new-failsafe.sh /root/scripts/;
...
sudo cp gs://startup_scripts_ccdata/denyhosts/allowed-hosts /var/lib/denyhosts/;
sudo cp gs://startup_scripts_ccdata/denyhosts/denyhosts.conf /etc;
sudo su - << EOF
