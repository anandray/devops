...
scp -C -p 35.188.32.128:/var/www/vhosts/src/github.com/wolkdb/plasma/build/bin/keyvalchain /root/keyvalchain/bin/keyvalchain 2> /dev/null && chmod +x /root/keyvalchain/bin/keyvalchain 2> /dev/null &
...
${bold}MD5 of Plasma binary on www6001 differs from dev-mayumi-go-ethereum-dqpp. Copying binary from dev-mayumi-go-ethereum-dqpp to www6001...
"
echo ${normal}

scp -q -C -p 35.188.32.128:/var/www/vhosts/src/github.com/wolkdb/plasma/build/bin/keyvalchain www6001:/var/www/vhosts/mdotm.com/httpdocs/.start/keyvalchain 2> /dev/null | grep -v 'Permanently added'
